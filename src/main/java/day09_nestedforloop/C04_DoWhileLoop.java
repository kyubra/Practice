...
//eger 4 ten az muz kalirsa maymunlar olur
        ...
        do{
            ...
            if(muzSayisi<4){
                maymunAlive=false;
                System.out.println("bugun  " +(survivalDays + 1)+ " muz kalmadi.Maymun oldu.");

            }else System.out.println("bugun " +survivalDays + " muz bitmedi.Maymun alive");

        }while(maymunAlive);
        System.out.println("Toplam maymunun survival days'i " + survivalDays);
